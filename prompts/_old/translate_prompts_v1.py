...
def translate_sys_prompt(src_lang, tgt_lang, software_type, source_type):
    ...
    elif source_type == "Content Pack":
        specific_type_name = f"The effect name of {software_type}"
        specific_type_instruction = [
            "Assign a name to the effect.",
            "There’s no need to strictly follow the source text.",
            "The name should accurately reflect the effect's content.",
            "The effect’s content should be presented in the 'use condition.'",
            "The name should be short and fit seamlessly within the software interface.",
            "The name should be easy for users to understand.",
            "The name should be easy for users to remember.",
            "Do not modify placeholders, variables, or formatting codes.",
            "Ensure the name is appropriate for the target culture and language.",
            "Prioritize the intended meaning over literal translation."
        ]
...
#     if source_type == "Content Pack":
#         specific_type_name = f"The effect name of {software_type}"
#         specific_type_instruction = [
#             "Assign a name to the effect.",
#             # "You can refer to 'refer english effect name' when naming the effect, but no need to strictly follow the source text.",
#             "The name should accurately reflect the effect's content.",
#             "The effect’s name should convey the 'use condition' content clearly.",
#             "The name should be short and fit seamlessly within the software interface.",
#             "The name should be easy for users to understand.",
#             "The name should be easy for users to remember.",
#             "Do not modify placeholders, variables, or formatting codes.",
...
#             "terms": translate_refer
#         },
#         # "refer english effect name": json_str,
#         "output_format": "json (key: 'translation' with translated text as value)"
#     }
#     if refer_text_condition:
#         translation_prompt["use condition"] = {
